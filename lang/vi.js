...
exports.transErrors = {
    enter_account: "Đăng nhập bằng tài khoản và mật khẩu của bạn.",
    enter_all_fields: "Vui lòng nhập hết các yêu cầu.",
    ...
    google_signup_failed: "Đăng ký tài khoản với google không thành công!",
    facebook_signup_failed: "Đăng ký tài khoản với facebook không thành công!",
    local_signup_failed: "Đăng ký tài khoản không thành công!",
    error_login: "Có lỗi xảy ra khi đăng nhập, vui lòng thử lại!",
...
exports.transSuccess = {
    ...
    signup_success: "Đăng ký tài khoản thành công, tiếp tục đăng nhập để truy cập tài khoản.",
