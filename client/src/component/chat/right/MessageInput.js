...
const MessageInput = ({conversation, setNewConver}) => {
            ...
            <form className="d-flex align-items-center">
                ...
                <div className="chat-attagement d-flex">
                    <div className="icon-chat" ref={node1}>
                        <i onClick={handleClickMess} className="fa fa-smile-o pr-3" aria-hidden="true"></i>
                        {
                            showEmoji? <div className="mess-input-picker"><Picker onSelect={onChangeEmoji} darkMode={true}/> </div>: null
                        }
                    </div>
                    <label htmlFor={`image-chat-${conversation._id}`} >
                        <input type="file" 
