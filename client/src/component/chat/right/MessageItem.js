                        ...
                        <div className="chat">
                            <div className="chat-user">
                                <Link to={`/profile/${user._id}`} className="avatar m-0">
                                    <img src={`${process.env.REACT_APP_API}/${user.avatar}`} alt="avatar" className="avatar-35 " />
                                </Link>
                        ...
                        <div className="chat chat-left">
                            <div className="chat-user">
                                <Link to={`/profile/${message.sender._id}`} className="avatar m-0">
                                    <img src={`${process.env.REACT_APP_API}/${message.sender.avatar}`} alt="avatar" className="avatar-35 " />
                                </Link>
                                <span className="chat-time mt-1"><Moment format='HH:mm'>{message.createdAt}</Moment></span>
                            </div>
                            <div className="chat-detail">
