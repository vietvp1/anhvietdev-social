        ...
        <div className="col-lg-3 chat-data-left scroller">
            ...
            <div className="d-flex align-items-center">
                <div className="chat-profile mr-3">
                    <img src={`${process.env.REACT_APP_API}/${user.avatar}`}     alt="chat-user" className="avatar-60 " />
                </div>
                                ...
                                href={`#chatbox_${c._id}`}>
                                    <div className="d-flex align-items-center">
                                        <div className="avatar mr-2">
                                            <img src={`${process.env.REACT_APP_API}/${c.userChat.avatar}`} alt="chatuserimage" className="avatar-50 " />
